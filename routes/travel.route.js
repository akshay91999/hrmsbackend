...
router.get('/pending/:id', travelController.findTravelById); // both pending and accepted trip for employee
router.get('/edit/:id', travelController.editTravelById); // edit pending  trip for employee
